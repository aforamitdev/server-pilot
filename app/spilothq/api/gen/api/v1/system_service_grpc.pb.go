...
type SystemServicesClient interface {
	GetStatus(ctx context.Context, in *protogen.StatusRequest, opts ...grpc.CallOption) (*protogen.StatusResponse, error)
}
...
func (c *systemServicesClient) GetStatus(ctx context.Context, in *protogen.StatusRequest, opts ...grpc.CallOption) (*protogen.StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(protogen.StatusResponse)
...
type SystemServicesServer interface {
	GetStatus(context.Context, *protogen.StatusRequest) (*protogen.StatusResponse, error)
	mustEmbedUnimplementedSystemServicesServer()
}

// UnimplementedSystemServicesServer must be embedded to have forward compatible implementations.
type UnimplementedSystemServicesServer struct {
}

func (UnimplementedSystemServicesServer) GetStatus(context.Context, *protogen.StatusRequest) (*protogen.StatusResponse, error) {
...
func _SystemServices_GetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SystemServicesServer).GetStatus(ctx, req.(*protogen.StatusRequest))
	}
...
var SystemServices_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/spilothq/api/v1/system_service.proto",
}
