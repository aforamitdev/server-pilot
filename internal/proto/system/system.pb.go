...
func (x *LogReponse) Reset() {
	*x = LogReponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_proto_system_system_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogReponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_system_system_proto_rawDescGZIP(), []int{2}
}

func (x *LogReponse) GetLog() string {
	if x != nil {
		return x.Log
	}
	return ""
...
func (x *LogRequest) Reset() {
	*x = LogRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_proto_system_system_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_system_system_proto_rawDescGZIP(), []int{3}
}
...
var file_internal_proto_system_system_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x1e, 0x0a, 0x0a, 0x4c,
	0x6f, 0x67, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6c, 0x6f, 0x67,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x22, 0x0c, 0x0a, 0x0a, 0x4c,
	0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x32, 0x5f, 0x0a, 0x08, 0x49, 0x6e, 0x66,
	0x6f, 0x72, 0x6d, 0x65, 0x72, 0x12, 0x2c, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74,
	...
	0x6e, 0x73, 0x65, 0x12, 0x25, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x0b,
	0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x4c, 0x6f,
	0x67, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x41, 0x5a, 0x3f, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x66, 0x6f, 0x72, 0x61, 0x6d, 0x69,
	0x74, 0x64, 0x65, 0x76, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2d, 0x70, 0x69, 0x6c, 0x6f,
	0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70,
...
var file_internal_proto_system_system_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_internal_proto_system_system_proto_goTypes = []any{
	(*SystemRequest)(nil),  // 0: SystemRequest
	(*SystemResponse)(nil), // 1: SystemResponse
	(*LogReponse)(nil),     // 2: LogReponse
...
var file_internal_proto_system_system_proto_depIdxs = []int32{
	...
	3, // 1: Informer.GetLogs:input_type -> LogRequest
	1, // 2: Informer.GetSystem:output_type -> SystemResponse
	2, // 3: Informer.GetLogs:output_type -> LogReponse
...
func file_internal_proto_system_system_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_proto_system_system_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internal_proto_system_system_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_internal_proto_system_system_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_internal_proto_system_system_proto_msgTypes[3].Exporter = func(v any, i int) any {
